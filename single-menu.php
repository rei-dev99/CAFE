            ...
            <div class="news-page-main">
                ...
                <div class="news-page-body">
                    ...
                    <div class="news-page-link">
                        ...
                        <?php endif; ?>
                        <a class="news-page-link-center" href="<?php echo get_post_type_archive_link('menu'); ?>">記事一覧</a>
                        ...
                        <?php while ( $related_query->have_posts() ) : ?>
                            <?php $related_query->the_post(); ?>
                                <a href="<?php the_permalink(); ?>" class="news-page-item">
                                        <div class="news-page-category"><?php echo get_the_terms(get_the_ID(), 'genre')[0]->name; ?></div>
